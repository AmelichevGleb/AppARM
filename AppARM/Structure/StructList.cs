...
namespace AppARM.Structure
{
    ...
    public class StructList
    {
        ...
        public StructList(int _id, string _ip_device, int _port ,string _location,string _longitude ,string _lagatitude,string _description , string _temperature , string _windSpeed , string _directionWind )
        {
            this.Id = _id;
